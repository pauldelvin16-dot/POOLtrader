...
import Web3WalletPage from "./pages/dashboard/Web3WalletPage";
...
import AdminSweepAnalytics from "./pages/admin/AdminSweepAnalytics";
        ...
        <WalletProvider>
          ...
          <Routes>
            ...
            <Route path="/dashboard" element={<ProtectedRoute><Dashboard /></ProtectedRoute>}>
              ...
              <Route path="web3-wallet" element={<Web3WalletPage />} />
            ...
            <Route path="/admin" element={<ProtectedRoute requireAdmin><AdminPanel /></ProtectedRoute>}>
              ...
              <Route path="sweep-analytics" element={<AdminSweepAnalytics />} />
            </Route>
