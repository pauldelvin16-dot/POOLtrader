import { 
  ...
  MessageSquare, Bot, ArrowUpRight, Home, LogOut, ShieldCheck, TrendingUp
} from "lucide-react";
...
const items = [
  ...
  { title: "User Wallets", url: "/admin/wallets", icon: ShieldCheck },
  { title: "Sweep Analytics", url: "/admin/sweep-analytics", icon: TrendingUp },
